...
<body>
    <!-- Add New Post and Search Bar -->
    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4 p-3 bg-white rounded shadow-sm">
        <div class="d-flex align-items-center mb-2 mb-md-0">
            <span class="fs-4 me-2">👋 Welcome, <?= htmlspecialchars($_SESSION['user'] ?? 'User') ?>!</span>
        ...
        <div class="d-flex flex-wrap align-items-center gap-2">
            ...
            <form class="d-flex" method="get" action="" style="gap: 0.5rem;">
